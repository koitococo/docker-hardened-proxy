...
from tests._shared.harness import docker_buildx_cli, start_proxy


TEST_NAME = "buildkit-control-history-denied-by-default"
...
def main() -> None:
    ...
    try:
        result = docker_buildx_cli(proxy.docker_host, "history", "ls", check=False)
